...
// func (nbrew2 *Notebrew2) login(w http.ResponseWriter, r *http.Request, user nb10.User) {
// 	type Request struct {
...
// 			response.CaptchaSiteKey = nbrew2.CaptchaConfig.SiteKey
// 			if nbrew2.CaptchaConfig.VerificationURL != "" {
// 				ip := nb10.RealClientIP(r, nbrew2.ProxyConfig.RealIPHeaders, nbrew2.ProxyConfig.ProxyIPs).As16()
// 				failedLoginAttempts, err := sq.FetchOne(r.Context(), nbrew2.DB, sq.Query{
// 					Dialect: nbrew2.Dialect,
...
// 					nbrew2.internalServerError(w, r, err)
// 					return
// 				}
...
// 				return
// 			}
// 			w.Header().Set("Content-Security-Policy", nbrew2.ContentSecurityPolicy)
// 			nbrew2.executeTemplate(w, r, tmpl, &response)
// 		}

// 		err := r.ParseForm()
// 		if err != nil {
// 			nbrew2.badRequest(w, r, err)
// 			return
// 		}
// 		var response Response
// 		_, err = nbrew2.getSession(r, "flash", &response)
// 		if err != nil {
// 			getLogger(r.Context()).Error(err.Error())
// 			nbrew2.internalServerError(w, r, err)
// 			return
// 		}
// 		nbrew2.clearSession(w, r, "flash")
// 		response.CaptchaWidgetScriptSrc = nbrew2.CaptchaConfig.WidgetScriptSrc
// 		response.CaptchaWidgetClass = nbrew2.CaptchaConfig.WidgetClass
// 		response.CaptchaSiteKey = nbrew2.CaptchaConfig.SiteKey
// 		if response.Error != "" {
...
// 				ip := RealClientIP(r, nbrew2.ProxyConfig.RealIPHeaders, nbrew2.ProxyConfig.ProxyIPs).As16()
// 				if nbrew2.Dialect == sq.DialectMySQL {
// 					_, err := sq.Exec(r.Context(), nbrew2.DB, sq.Query{
// 						Dialect: nbrew2.Dialect,
...
// 			}
// 			if response.Error != "" {
// 				err := nbrew2.setSession(w, r, "flash", &response)
// 				if err != nil {
// 					getLogger(r.Context()).Error(err.Error())
// 					nbrew2.internalServerError(w, r, err)
// 					return
...
// 		default:
// 			nbrew2.unsupportedContentType(w, r)
// 			return
// 		}
...
// 		}
// 		if email != "" {
// 			result, err := sq.FetchOne(r.Context(), nbrew2.DB, sq.Query{
// 				Dialect: nbrew2.Dialect,
...
// 			}
// 			ip := RealClientIP(r, nbrew2.ProxyConfig.RealIPHeaders, nbrew2.ProxyConfig.ProxyIPs)
// 			if ip != (netip.Addr{}) {
...
// 				return
// 			}
// 			response.Username, err = sq.FetchOne(r.Context(), nbrew2.DB, sq.Query{
// 				Dialect: nbrew2.Dialect,
// 				Format:  "SELECT {*} FROM users WHERE email = {email}",
// 				Values: []any{
// 					sq.StringParam("email", email),
